...
with Harriet.Color.Table;

package body Harriet.Color is

   function Parse_Hex_Color (Spec : String) return Harriet_Color;
   ...
   begin
      ...
      elsif Harriet.Color.Table.Exists (Item) then
         return Harriet.Color.Table.Get (Item);
      else
         return White;
      end if;
   end From_String;

   function Parse_Hex_Color (Spec : String) return Harriet_Color is
